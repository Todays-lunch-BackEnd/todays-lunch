...
import LikeLion.TodaysLunch.security.CustomUserDetailService;
...
public class TodaysLunchConfig {
  ...
  public RestaurantService restaurantService() {
    return new RestaurantService(restaurantRepository, foodCategoryRepository,
        locationTagRepository, locationCategoryRepository);
  }
